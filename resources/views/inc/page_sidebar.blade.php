...
<aside class="page-sidebar">
    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        ...
        <ul id="js-nav-menu" class="nav-menu">
            ...
            @can('superadmin')
                <li class="{{ set_active_mainmenu(['users', 'units']) }}">
                    <a href="#" title="Master Data" data-filter-tags="master data">
                        <i class="fal fa-database"></i>
                        <span class="nav-link-text" data-i18n="nav.master_data">Master Data</span>
                    </a>
                    <ul>
                        <li class="{{ set_active('units') }}">
                            <a href="/units" title="Unit" data-filter-tags="master data unit">
                                <span class="nav-link-text" data-i18n="nav.master_data_unit">Unit</span>
                            </a>
                        </li>
                        <li class="{{ set_active('users') }}">
                            <a href="/users" title="User" data-filter-tags="master data user">
                                <span class="nav-link-text" data-i18n="nav.master_data_user">User</span>
                            </a>
                        </li>
                    </ul>
                </li>
